<template>
  <div>
    ...
    <br>
    <div>
      <button type="button" class="btn btn-dark" @click="createSubModal">
        Create Subscriber
      </button>
    </div>
    ...
    <modal name="edit-sub" adaptive height="auto" style="scroll: auto">
      <form style="padding: 25px;">
        ...
        <select v-model="state" name="state" class="custom-select custom-select-md mb-3">
          <option value="active">
            Active
          </option>
        ...
        <button type="submit" class="btn btn-primary" @click="updateSub">
          Update
        </button>
        <button type="submit" class="btn btn-danger" @click="deleteSub">
          Delete
        </button>
        ...
        <div style="padding: 15px">
          ...
          <form>
            <div class="form-group">
              ...
              <input v-model="title" type="text" name="title" class="form-control" aria-describedby="emailHelp" placeholder="Enter field title">
            </div>
            <div class="form-group">
              <label for="type">Type (string, number, boolean, date)</label>
              <input v-model="type" type="text" name="type" class="form-control" placeholder="Enter field type">
            </div>
            <button type="submit" class="btn btn-primary" @click="addField">
              Add
            </button>
          </form>
        </div>
    ...
    <modal name="create-sub" adaptive height="auto">
      <form style="padding: 25px;">
        ...
        <button type="submit" class="btn btn-primary" @click="createSub">
          Create
        </button>
      </form>
    </modal>
